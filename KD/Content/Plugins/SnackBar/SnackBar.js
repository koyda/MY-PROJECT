...
function SnackBar(userOptions) {
    ...
    function _Create() {
        ...
        if (!_Container) {
            ...
            _Container.classList.add("main-snackbar-container");
        ...
        _Element.classList.add("mian-box-snackbar");

        var innerSnack = document.createElement("div");
        innerSnack.classList.add("main-left-snackbar", "js-snackbar--show");
    ...
    var searchChildren = function (target) {
        ...
        for (i = 0; i < htmlCollection.length; i++) {
            ...
            if (node.nodeType === 1 && node.classList.length > 0 && node.classList.contains("main-snackbar-container")) {
                return node;
            }
        }
...
// }
    ...
    // <div class="js-snackbar-container js-snackbar-container--fixed">
    //     <div class="js-snackbar__wrapper">
    //         <div class="js-snackbar js-snackbar--show">

    //             <span class="js-snackbar__status js-snackbar--success"></span>
    //             <span class="js-snackbar__message"> Success !</span><span class="js-snackbar__close">×</span>
           
    //         </div>
    //     </div>
    // </div>

    // <div class="main-snackbar-container">
    //     <div class="mian-box-snackbar status-success-snackbar">

    //         <div class="main-left-snackbar">

    //             <div class="main-icon-snackbar"><img src="~/Content/Assets/icon/check.png" /></div>
    //             <div class="main-detail-snackbar">
    //                 <div class="main-text-status-snackbar">Success !</div>
    //                 <div class="main-text-detail-snackbar"></div>
    //             </div>

    //         </div>

    //         <div class="main-btn-close-snackbar"><img src="~/Content/Assets/icon/close.png" /></div>
    //     </div>
    // </div>
